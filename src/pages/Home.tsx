...
import { BookOpen, TrendingUp, Clock, Award, CheckCircle, Users, Target, Mail, Phone, MapPin, Clock as ClockIcon, GraduationCap } from 'lucide-react';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-blue-100 mb-8 text-lg">
              Мэргэжлийн багш нар, орчин үеийн арга зүй, баталгаат үр дүнгээр таны мөрөөдлийн оноог авахад тусална
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/exercises">
                <Button variant="outline" className="px-8 py-6 bg-white/10 backdrop-blur-sm text-white border-white/30 hover:bg-white/20">
                  Дасгал үзэх
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              IELTS шалгалтад амжилттай тэнцэхэд шаардлагатай бүх зүйл нэг дороос
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card key={index} className="border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-gray-900 mb-6">
                Таны амжилтын түлхүүр
              </h2>
              <p className="text-gray-600 mb-8">
                IELTS Заавар нь олон мянган суралцагчдад амжилттай тэнцэхэд нь туслсан туршлагатай платформ юм. Бид таны хэрэгцээнд тохирсон, өндөр чанартай материалаар хангана.
              </p>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                    ...
                    <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">10,000+</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg">
                    ...
                    <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">500+</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg">
                    ...
                    <span className="bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">95%</span>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {values.map((value, index) => (
              <Card key={index} className="border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <CardContent className="p-6 text-center">
                  <div className={`w-16 h-16 bg-gradient-to-br ${value.color} rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg`}>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {team.map((member, index) => (
                <Card key={index} className="border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  <CardContent className="p-6 text-center">
                    <div className={`w-24 h-24 bg-gradient-to-br ${member.gradient} rounded-full mx-auto mb-4 flex items-center justify-center text-white shadow-lg`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div className="p-6 bg-white rounded-xl shadow-md">
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent text-4xl mb-2">10,000+</div>
              <div className="text-gray-600">Суралцагч</div>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-md">
              <div className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent text-4xl mb-2">500+</div>
              <div className="text-gray-600">Дасгал тест</div>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-md">
              <div className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent text-4xl mb-2">95%</div>
              <div className="text-gray-600">Амжилтын хувь</div>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-md">
              <div className="bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent text-4xl mb-2">7.5</div>
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Асуулт, санал, хүсэлт байвал бидэнтэй холбогдоорой. Бид танд тусалахад таатай байна.
            </p>
          </div>
