      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            IELTS-ийн бүх хэсгүүдийг дадлагажуулаарай
          </p>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-700 mb-4">
                  Өөрийн одоогийн англи хэлний түвшингээ мэдэж, тохирох
                  дасгалуудыг олоорой
                </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {testCategories.map((category) => (
            <Card
              key={category.id}
              className="border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer"
            >
              <CardContent className="p-6">
                <div
                  className={`w-14 h-14 bg-gradient-to-br ${category.gradient} rounded-xl flex items-center justify-center mb-4 shadow-lg`}
                >
